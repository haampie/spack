# Distinct spec bugs fixed, 2026-07-17 to 2026-08-18
...
| Bucket | Bugs | PRs |
|---|---|---|
| Merged to develop | **41** | 21 |
| Open extraction PRs | **6** | 1 |
...
## Open extraction PRs (6 bugs)

**#52856 — ArchSpec: fix satisfies, intersects, constrain**
...
Re-verified on 2026-08-17 on develop-shaped code: still broken with the open PRs applied.
