...
# spack repo migrate
set -g __fish_spack_optspecs_spack_repo_migrate h/help patch= fix
...
complete -c spack -n '__fish_spack_using_command repo migrate' -l patch -r -f -a patch
complete -c spack -n '__fish_spack_using_command repo migrate' -l patch -r -d 'generate a patch file for the migration without applying it'
