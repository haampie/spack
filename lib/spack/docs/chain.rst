...
This other Spack instance has no knowledge of the local Spack instance
...
#. If a package is installed both locally and upstream, the local installation
   ...
   installation installs a package that is not present in the upstream, but later on, the
